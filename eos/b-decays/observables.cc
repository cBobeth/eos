    ...
    make_b_to_dstar_l_nu_group()
    {
        auto imp = new Implementation<ObservableGroup>(
            ...
            R"(The option "form-factors" selects the form factor parametrization.)",
            {
                ...
                make_observable_sum("B->D^*lnu::barBR", R"(\overline{\mathcal{B}}^{(\mu+e)})",
                                &BToVectorLeptonNeutrino::integrated_branching_ratio,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::DeltaBR", R"(\Delta \mathcal{B}^{(\mu-e)}})",
                                &BToVectorLeptonNeutrino::integrated_branching_ratio,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +1.0,
               ...
               make_observable("B->D^*lnu::BR^CPave", R"(\mathcal{B}^{\text{CPave}}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_branching_ratio,
                                std::make_tuple("q2_min", "q2_max")),

                make_observable_sum("B->D^*lnu::barBR^CPave", R"(\overline{\mathcal{B}}^{\text{CPave},(\mu+e)})",
                                &BToVectorLeptonNeutrino::integrated_CPave_branching_ratio,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::DeltaBR^CPave", R"(\Delta \mathcal{B}^{\text{CPave},(\mu-e)}})",
                                &BToVectorLeptonNeutrino::integrated_CPave_branching_ratio,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +1.0,
                ...
                make_observable_sum("B->D^*lnu::barA_FB", R"()",
                                &BToVectorLeptonNeutrino::integrated_a_fb_leptonic,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::barF_L", R"()",
                                &BToVectorLeptonNeutrino::integrated_f_L,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::barFtilde_L", R"()",
                                &BToVectorLeptonNeutrino::integrated_ftilde_L,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::barJ_3", R"()",
                                &BToVectorLeptonNeutrino::integrated_J3,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable("B->D^*lnu::A_FB^CPave", R"(A_{\text{FB}}^{\text{CPave}}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_a_fb_leptonic,
                                std::make_tuple("q2_min", "q2_max")),

                make_observable_sum("B->D^*lnu::barA_FB^CPave", R"(\overline{A}_{\text{FB}}^{(\mu+e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_a_fb_leptonic,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::DeltaA_FB^CPave", R"(\Delta A_{\text{FB}}^{(\mu-e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_a_fb_leptonic,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +1.0,
                ...
                make_observable("B->D^*lnu::F_L^CPave", R"(F_{\text{L}}^{\text{CPave}}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_f_L,
                                std::make_tuple("q2_min", "q2_max")),

                make_observable_sum("B->D^*lnu::barF_L^CPave", R"(\overline{F}_L^{(\mu+e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_f_L,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::DeltaF_L^CPave", R"(\Delta F_L^{(\mu-e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_f_L,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +1.0,
                ...
                make_observable("B->D^*lnu::Ftilde_L^CPave", R"(\widetilde{F}_L^{\text{CPave}}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_ftilde_L,
                                std::make_tuple("q2_min", "q2_max")),

                make_observable_sum("B->D^*lnu::barFtilde_L^CPave", R"(\overline{\widetilde{F}}_L^{(\mu+e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_ftilde_L,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::DeltaFtilde_L^CPave", R"(\Delta \widetilde{F}_L^{(\mu-e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_CPave_ftilde_L,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +1.0,
                ...
                make_observable_sum("B->D^*lnu::barS_3", R"(\overline{S}_3^{(mu+e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_S3,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +0.5,
                ...
                make_observable_sum("B->D^*lnu::DeltaS_3", R"(\Delta S_3^{(\mu-e)}(B\to \bar{D}^*\ell^-\bar\nu))",
                                &BToVectorLeptonNeutrino::integrated_S3,
                                std::make_tuple("q2_mu_min", "q2_mu_max"),
                                Options{ { "l", "mu" } },
                                +1.0,
